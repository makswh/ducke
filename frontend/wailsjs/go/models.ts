...
export namespace downloader {
	...
	export class TorrentSeedQuery {
	    id: number;
	    magnetUri: string;
	
	    static createFrom(source: any = {}) {
	        return new TorrentSeedQuery(source);
	    }
...
export namespace main {
	...
	export class FavoriteLaunchConfig {
	    exePath: string;
	    launchArgs: string;
	
	    static createFrom(source: any = {}) {
	        return new FavoriteLaunchConfig(source);
	    }
...
export namespace metadata {
	...
	export class SteamAnonymizedReview {
	    id: string;
	    votedUp: boolean;
	    review: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new SteamAnonymizedReview(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.id = source["id"];
	        this.votedUp = source["votedUp"];
	        this.review = source["review"];
	        this.playtimeHours = source["playtimeHours"];
	        this.playtimeAtReview = source["playtimeAtReview"];
	        this.votesUp = source["votesUp"];
	        this.votesFunny = source["votesFunny"];
	...
	export class SteamReviewsResponse {
	    ...
	    static createFrom(source: any = {}) {
	        return new SteamReviewsResponse(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.reviews = this.convertValues(source["reviews"], SteamAnonymizedReview);
...
export namespace steam {
	...
	export class SteamExportResult {
	    appid: number;
	    appname: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new SteamExportResult(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.steamRunning = source["steamRunning"];
	        this.shortcutsVdf = source["shortcutsVdf"];
	        this.gridDir = source["gridDir"];
	        this.message = source["message"];
	    }
	}
